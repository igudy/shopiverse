...
const Register = () => {
  return (
    ...
    {/* <div className='bg-gradient-to-t from-purple-500 to-purple-300 h-10 sm:w-full'></div> */}
      ...
      <div className='flex flex-col mx-10 sm:mx-2 xsm:mx-2 p-5 my-7 shadow-2xl right-0'>
        ...
        <div className="flex flex-col text-sm">
            <div className='flex md:gap-2 lg:gap-10 xl:gap-10 items-center justify-between sm:block'>
              <div className='flex flex-col'>
                ...
                <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 rounded-lg md:w-full w-60 sm:w-full p-2.5  " placeholder="John" required/>
              </div>

              <div className='flex flex-col'>
                <label htmlFor="last_name" className="my-1 ml-1">Last name</label>
                <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 rounded-lg p-2.5 md:w-full w-60 sm:w-full" placeholder="Doe" required/>
              </div>
            </div>
        </div>
        <div className="my-3">
        ...
        <div className="my-3">
            ...
            className="mb-2">Confirm password</label>
            <input type="password" 
              id="confirm_password" 
    ...
    <div className='my-3 text-lg text-center justify-center sm:w-full sm:text-sm'>
      Have an account? <span className='text-blue-700 hover:text-blue-900 font-medium cursor-pointer underline'><Link to="/login">
        Log In Now
        </Link>
        </span>
      </div>
    ...
    <div className='flex-row flex justify-center cursor-pointer sm:w-full'>
      <div className='text-lg sm:text-sm flex border-2 rounded-full hover:bg-purple-200 w-72 items-center justify-center text-center'>
        <img src={Google} className='w-6 h-6 mx-2 sm:w-4 sm:h-4 sm:text-sm' alt='google_image' />Login with google
      </div>
    </div>
