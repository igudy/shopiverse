    ...
    <div>
      ...
      <div className="flex flex-col justify-center text-center sm:my-10 xsm:my-10 my-40">
        ...
        <div className="flex justify-center text-center">
          <button
            className="mt-4 text-white bg-purple-800 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg w-72 mx-2 px-5 py-2.5 text-center sm:w-full"
